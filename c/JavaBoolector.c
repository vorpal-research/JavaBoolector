...
Java_Native_write(JNIEnv *env, jobject jobj, jlong jnode_array_ref, jlong jnode_index_ref, jlong jnode_value_ref) {
    BoolectorNode *array = (BoolectorNode *) jnode_array_ref;
    BoolectorNode *index = (BoolectorNode *) jnode_index_ref;
...
JNIEXPORT jlong JNICALL
Java_Native_cond(JNIEnv *env, jobject jobj, jlong jnode_cond_ref, jlong jnode_first_ref, jlong jnode_second_ref) {
...
JNIEXPORT jlong JNICALL
Java_Native_fun(JNIEnv *env, jobject jobj, jlongArray jparams, jint jlength, jlong body_node_ref) {
...
JNIEXPORT jlong JNICALL
Java_Native_forAll(JNIEnv *env, jobject jobj, jlongArray jparams, jint jlength, jlong body_node_ref) {
    BoolectorNode *body_node = (BoolectorNode *) body_node_ref;
    uint32_t size = (uint32_t) jlength;
    long *ref_params = (*env)->GetLongArrayElements(env, jparams, 0);
    BoolectorNode **params = ref_array_to_type(ref_params, size);
...
JNIEXPORT jlong JNICALL
Java_Native_apply(JNIEnv *env, jobject jobj, jlongArray jargs, jint jlength, jlong fun_node_ref) {
